...
tgt_dir = os.path.join(os.environ['BOP_PATH'],'husky',split_type,sequence_number)
...
cli_args = [launch_file,sequence_number_arg,sleepbf_arg,bagdir_arg, bagdelay_arg, dummynr_arg]
