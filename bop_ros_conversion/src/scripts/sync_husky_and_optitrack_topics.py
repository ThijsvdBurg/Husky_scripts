...
# below are the standard cli argument parsing lines
...
# below are the lines for the roslaunch implementation
slopparam = rospy.get_param('~slop')
...
ts = message_filters.ApproximateTimeSynchronizer([leftinfo_sub, leftimage_sub, rightinfo_sub, rightimage_sub, robot_sub, object_sub], queue_size=30, slop=slopparam)
